      ...
      <div className="flex items-center justify-end px-3">
        <div className="px-3 shadow-md rounded-lg bg-blue-200 mt-2">
          <label className="relative inline-flex items-center cursor-pointer my-2">
            ...
            />
            <div className="peer ring-0 bg-rose-400  rounded-full outline-none
             duration-300 after:duration-500 w-8 h-8  shadow-md
              peer-checked:bg-emerald-500 peer-focus:outline-none  after:content-['✖️'] 
              after:rounded-full after:absolute after:outline-none after:h-6 after:w-6
               after:bg-gray-50 after:top-1 after:left-1 after:flex after:justify-center 
