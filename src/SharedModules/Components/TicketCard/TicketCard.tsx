            ...
            data?.role == "User" && ticket.status == "waitPayment" ? (
              ...
              <div className="my-2">
                ...
                disabled
                  ...
                  className="inline-flex items-center px-4 py-2 opacity-0  bg-red-600 transition ease-in-out delay-75 hover:bg-red-700 text-white text-sm font-medium rounded-md hover:-translate-y-1 hover:scale-110"
                >
                  <svg
                    stroke="currentColor"
                    viewBox="0 0 24 24"
